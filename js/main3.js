...
function displayCityWeather(data) {
    ...
    var cPpaltmp_min = document.getElementById('cPpaltmp_min');
    var cPpaltmp_max = document.getElementById('cPpaltmp_max');
    ...
    var c1humidity = document.getElementById('c1humidity');
    ...
    var c2humidity = document.getElementById('c2humidity');
    ...
    var c3humidity = document.getElementById('c3humidity');
    ...
    temperature.innerHTML = ((parseInt(data.list[0].main.temp) - 32) * (5 / 6)).toFixed(1) + " <span>&#176;</span>C";
    cPpaltmp_min.innerHTML = "Min: " + ((parseInt(data.list[0].main.temp_min) - 32) * (5 / 6)).toFixed(2) + " &deg;C";
    cPpaltmp_max.innerHTML = "Max: " + ((parseInt(data.list[0].main.temp_max) - 32) * (5 / 6)).toFixed(2) + " &deg;C";
    ...
    c1humidity.innerHTML =  "Humidity : "+data.list[8].main.humidity+ " %";
    ...
    c2humidity.innerHTML =  "Humidity : "+data.list[16].main.humidity+ " %";
    //day 3
    ...
    c3humidity.innerHTML =  "Humidity : "+ data.list[24].main.humidity+ " %";
};
